...
# Running `python benchmarks/k3_full_vision_smoke.py` otherwise makes `benchmarks/` the
# import root on some Python launchers. Pin the repository root explicitly so the
# self-hosted gate always imports this checkout's `local.k3_vision` implementation.
